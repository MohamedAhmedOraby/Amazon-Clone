...
class CartrDetail (models.Model) : 
...
class OrderDetail (models.Model) : 
    user = models.ForeignKey(Order,related_name='order_detail',on_delete=models.CASCADE)
    order = models.ForeignKey(Product,related_name='order_product',on_delete=models.SET_NULL,null=True,blank=True)
    quantity = models.IntegerField()
    price = models.FloatField()
